...
const BottomSheet2 = forwardRef((props, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        ...
        closeSheet: () => {
            const currentType = sheetType;
            rbsheetRef.current.close();

            if (currentType === "SkipLoginSheet") {
                setTimeout(() => {
                    setSheetType("SkipLoginSheet");
        ...
        <>
            <RBSheet
                ...
                height={sheetType === "gender" ? 150 :
                        ...
                        sheetType === "notification" ? 340 :
                        sheetType === "SkipLoginSheet" ? 445 :
            ...
            >
                ...
                {(sheetType === "SkipLoginSheet") &&
                    <SkipLoginSheet2 moresheet2={rbsheetRef}/>
                }
                {(sheetType === "filter") &&
...
const SkipLoginSheet2 = ({ moresheet2 } : { moresheet2 : any}) => {
    return(
        <View>
            <SkipLoginSheet
                moresheet2={moresheet2}
